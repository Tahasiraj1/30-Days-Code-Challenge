...
function concatenateFirstLetters(arr1: string[], arr2: string[], arr3: string[]): string[] {
    // Helper function.
    function firstLetter(arr: string[]): string {
    ...
    const firstArr: string = firstLetter(arr1);
    const secondArr: string = firstLetter(arr2);
    const thirdArr: string = firstLetter(arr3);
